...
from .views import MailingCreateView, MailingDetailView, MessageCreateView, ClientListView, MailingListView, HomeView, DeliveryReportView, MailingDeleteView, ClientCreateView, MailingUpdateView
